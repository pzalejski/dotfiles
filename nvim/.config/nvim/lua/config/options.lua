...
vim.opt.lazyredraw = true                      -- prevents excessive redraws during fast scrolling or macros
...
vim.opt.wildmenu = true -- Enable visual completion menu in command mode

-- Folding
-- vim.opt.foldexpr = 'v:lua.vim.treesitter.foldexpr()' -- (Disabled) Tree-sitter-based folding expression
vim.opt.foldmethod = 'indent' -- Use indent levels to define code folds (faster and more lightweight)
vim.opt.foldenable = true     -- Enable folding by default when opening files
vim.opt.foldlevel = 99        -- Open all folds by default (99 = deep enough to show everything)
